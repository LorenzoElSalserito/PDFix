...
### Changed
- La descrizione dei pacchetti diventa «Your Swiss Army knife for PDFs» in tutti i punti in cui finisce in chiaro davanti a chi installa: manifesto npm, synopsis e descrizione estesa del `.deb`, commento della voce di menu, sommario dello snap. La formula precedente prometteva soltanto unione e conversione in PDF/A, mentre l'applicazione fa ormai ventisei operazioni: chi leggeva la scheda del pacchetto non lo sapeva.
